...
<div class="grid_10">
  <div style="height: 900px" class="box round first grid">
    <a href="{{URL::to('accountantlist')}}"><span style="border-bottom: 2px solid black" class="btn btn-dark"> All Accountant</span></a></h2>
  <h2 style="text-align: center;">Accountant List</h2>
<div class="block">
...
<label>Status</label>
 ...
 <td>{{ $result->emp_status}}</td>
  ...
  <tr>
  <td style="float:right"><a class="btn btn-info" href="{{ Route('accountantlist')}}" >OK</a></td>
