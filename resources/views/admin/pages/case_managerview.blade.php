...
<div class="grid_10">
  <div style="height: 900px" class="box round first grid">
    <a href="{{URL::to('case_managerlist')}}"><span style="border-bottom: 2px solid black" class="btn btn-dark"> All Case MangerList</span></a></h2>
  <h2 style="text-align: center;">Manager List</h2>
<div class="block">
<form action="/" method="" enctype="multipart/form-data">
  @csrf
   ...
   <tr>
   <td>
   <label>Case Manager Image</label>
 </td>
 <td>
...
<label>Status</label>
 ...
 <tr>
  <td style="float:right"><a class="btn btn-info" href="{{ Route('case_managerlist')}}" >OK</a></td>
