...
<div class="grid_10">
    <div style="height: 900px" class="box round first grid">
        ...
        <div class="block ">
            <form action="{{Route('invoiceupdate')}}/{{$patient_info->id}}" method="post">
                @csrf
                <table class="form">
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="patient_id" value="{{$patient_info->patient_id}}" >
                        </td>

                    </tr>
                    <tr>
                        <td>
                            <label>Change Medicine</label>
                        </td>
                        <td>
                        <select id="obj_medicine" name="medicine_id">
            <option>Edit Medicine Name</option>
  @foreach($m_list as $medicine)
          ...
          @endforeach
              ...
              @foreach($medicine_info as $i=>$medicine)
                            ...
                            <td><input name="price[]" value="{{$medicine->price}}" disabled="disabled" /> </td>
                            <td><input type="number" name="quantity[]" value="{{$medicine->quantity}}"/> </td>
                            <td><input type="number" name="total_price[]" value="{{$medicine->total_price}}"/> </td>
