...
<div class="grid_10">
    <div style="height: 900px;background-color: #bac1dc" class="box round first grid">
        ...
        <div class="block ">
            <form action="{{Route('lab_invoiceinsert')}}" method="post">
                @csrf
                <table class="form">
                    <tr>
                        <td>
                ...
                <div style="width: 100%;float: left;">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr class="bg-light">
                            ...
                            <th>
                                <input type="text" class="form-control tinputs" id="paid_amount" name="paid" placeholder="0" value="">
                            </th>
    ...
    $( document ).ready(function(){
        $('#obj_medicine').change(function(){
            ...
            var tr = "<tr>"+
                ...
                "<td>"+name+" </td>"+
                "<td><input class='form-control price_input price' type='' name='test_rate[]' value='"+test_rate+"' readonly='readonly'/></td>"+
