...
<div class="grid_10">
  <div style="height: 900px" class="box round first grid">
    <a href="{{URL::to('nurselist')}}"><span style="border-bottom: 2px solid black" class="btn btn-dark"> All Nurse</span></a></h2>
...
<tr>
<td style="float:right"><a class="btn btn-info" href="{{ Route('nurselist')}}">ok</a></td>
 </tr>
 </table>
 </form>
 </div>
