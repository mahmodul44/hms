...
@include ('admin.layouts.sidebar')
    ...
    <div class="grid_10">
    <div style="height: 920px;background-color: #bac1dc" class="box round first grid">
    <a href="{{Route('operationlist')}}"><span style="border-bottom: 2px solid black" class="btn btn-dark">Operation Report</span></a>
    <h2 style="text-align: center;background-color:white">Add Operation Info</h2>
     <div class="block copyblock">
      <form action="{{Route('operationinsert')}}" method="post" enctype="multipart/form-data">
               @csrf
        <table class="form">
