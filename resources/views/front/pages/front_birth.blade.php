...
<div class="container col-sm-6">
  ...
  <div class="card-body">
    <h5 class="card-title text-center">Select correct information For birth Certificate</h5>
  ...
  <hr>
  <form action="{{URL::to('front_birthinsert')}}" method="post">
      @csrf
...
<br>
 ...
 <br>
      <input style="border:none;border-bottom: 1px solid black" class="form-control" type="" placeholder="Child Name" name="cname">
 <br>
      <input style="border:none;border-bottom: 1px solid black" class="form-control" type="" placeholder="Father Name" name="fname">
      <br>
